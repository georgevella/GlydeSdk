...
namespace Glyde.AspNetCore.Bootstrapping
{
    public class AspNetCoreBootstrapperStage : IBootstrapperStage
    {
        ...
        public void RunStageBootstrappers(IEnumerable<Assembly> assemblies)
        {
            ...
            _services.AddSingleton<IControllerActivator>(new ControllerActivator(_container));
            //TODO: _services.AddSingleton<IViewComponentActivator>(new SimpleInjectorViewComponentActivator(_container));
        }
    }
}